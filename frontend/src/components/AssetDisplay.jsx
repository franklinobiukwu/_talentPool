...
//    if (isPending) return <p className="text-center text-gray-500">Loading asset details...</p>;
//    if (isError) return <p className="text-center text-red-500">Error: {error.message}</p>;

    return (
        <div className="w-full max-w-xl bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all hover:shadow-xl">
            {/* Image & Menu */}
            <div className="relative">
                ...
                {showMenu && (
                    <div className="absolute top-12 right-3 bg-white shadow-md rounded-lg border w-32 py-2">
                        ...
                        <button className="flex items-center gap-2 px-4 py-2 text-red-600 hover:bg-red-100 w-full">
